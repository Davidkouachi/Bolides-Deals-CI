    ...
    <div class="container-xl wide-xl">
        <div class="nk-content-body">
            <div class="nk-block nk-block-lg">
                <form class="nk-block" id="form_new_location" action="{{route('trait_annonce')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-gs" >
                        <div class="col-12">
...
<script src="{{asset('assets/js/app/js/annonce/new/location/download_image.js') }}"></script>
<script src="{{asset('assets/js/app/js/annonce/new/location/form.js') }}"></script>
