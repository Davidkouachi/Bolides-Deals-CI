...
<div class="nk-content nk-content-fluid">
    <div class="container-xl wide-xl">
        <div class="nk-content-body">
            ...
            <div class="nk-block">
                <div class="row g-gs">
                    <a class="col-sm-6 col-md-6 col-lg-3">
                        <div class="card card-full bg-white">
                            <div class="card-inner">
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <div class="fs-6 text-opacity-75 mb-0 text-black">
                                        Temps en ligne
                                    </div>
                                </div>
                                <h5 class="fs-1 text-black">
                                    30
                                    <small class="fs-3">
                                       Jours
                                    </small>
