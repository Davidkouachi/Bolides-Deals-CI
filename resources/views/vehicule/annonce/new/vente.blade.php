                                ...
                                <div class="card-inner card-inner-lg">
                                        <div id="contenu">
                                            ...
                                            <div class="row g-gs mb-4" >
                                                ...
                                                <div class="col-lg-4 col-md-6" id="div_imm" style="display: none;">
                                                    <div class="form-group">
                                                        <label class="form-label" for="cp1-team-size">
                                                            Immatriculation
                                                        </label>
                                                        <div class="form-control-wrap">
                                                            <input id="imm" required name="imm" type="text" class="form-control form-control-md" placeholder="Entrer l'immatriculation du véhicule sans espace" oninput="removeSpaces(this)">
                                                            <script>
                                ...
                                <div class="card-inner card-inner-lg">
                                        <div id="contenu">
                                            ...
                                            <div class="row g-gs mb-4" >
                                                ...
                                                <div class="col-lg-4 col-md-6" id="div_credit_auto_mois" style="display: none;">
                                                   <div class="form-group">
                                                ...
                                                <div class="col-lg-4 col-md-6" id="div_prix_apport" style="display: none;">
                                                   <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input required type="tel" class="form-control" id="prix_apport" placeholder="Apport initial du crédit auto" name="prix_apport" value="0">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-6" id="div_prix_mois" style="display: none;">
                                                   <div class="form-group">
                                                        <label class="form-label" for="default-05">
                                                            Somme a payée
                                                        </label>
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input required type="tel" class="form-control" id="prix_mois" name="prix_mois" value="0" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script src="{{asset('assets/js/app/js/annonce/new/vente/form.js') }}"></script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Écouter l'événement d'entrée sur les champs de texte
            document.getElementById('prix_apport').addEventListener('input', function() {
                this.value = formatPrice(this.value);
            });
            ...
            // Événement pour permettre uniquement les chiffres
            document.getElementById('prix_apport').addEventListener('keypress', function(event) {
                const key = event.key;
                if (isNaN(key)) {
                    event.preventDefault();
                }
